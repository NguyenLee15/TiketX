          ...
          <div className="surface-panel max-w-md w-full p-8 text-center shadow-2xl rounded-2xl border border-border-subtle">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <button
                ...
                className="inline-flex min-h-11 items-center justify-center gap-2 rounded-xl bg-brand-primary px-5 text-sm font-bold text-surface-0 hover:bg-brand-secondary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary cursor-pointer transition-colors"
              >
