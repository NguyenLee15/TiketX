...
export default function LegalPage() {
  ...
  return <article className="surface-panel mx-auto max-w-3xl p-6 sm:p-10">
    ...
    <div className="mt-8 space-y-6 text-sm leading-7 text-text-secondary">
      ...
      <section><h2 className="text-xl font-bold text-white">Liên Hệ</h2><p className="mt-2">Gửi yêu cầu đến <a className="text-brand-readable underline underline-offset-4" href="mailto:support@tickex.vn">support@tickex.vn</a>.</p></section>
    </div>
